...
(function (nx) {
    nx.define('ActionPanelView',nx.ui.Component, {
            ...
            content : [
                ...
                },
                {
                    ...
                    content : [
                        ...
                        {
                            name: '_loadJsonTextBox',
                            tag: 'input',
                            props : {
                                'id' : '_loadJsonTextBox',
                                'class' : 'textBox',
                                placeholder : 'Enter json file path',
                                'value' : '{browseFileTextBoxContent}'
                            }
                        },
                        {
                            tag : 'input',
        ...
        methods: {
            ...
            _changeFile : function(input) {
                fileName = input.value()
                if(fileName && fileName.indexOf('.json') + 5 == fileName.length) {
                    //debugger
                    this.model().browseFileObject(input._resources['@root'].$dom.files[0])
                    this.model().browseFileTextBoxContent(fileName)
                } else {
